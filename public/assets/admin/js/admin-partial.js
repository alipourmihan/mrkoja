$(document).ready(function () {
  ...
  $('#productForm').on('submit', function (e) {
    ...
    if (can_product_add == 0) {
      bootnotify('لطفاً یک پلن خریداری کنید تا محصول اضافه کنید.!', 'هشدار', 'warning');
      return false;
        } else if (can_product_add == 2) {
      $("#checkLimitModal").modal('show');
      bootnotify("محدودیت تعداد محصولات به پایان رسیده یا تجاوز کرده است", 'هشدار', 'warning');
      return false;
    }
    $('.request-loader').addClass('show');
    let action = $(this).attr('action');
  ...
  $("#CarSubmit").on('click', function (e) {
    ...
    if (can_car_add == 0) {
      ...
      bootnotify("شما نمی‌توانید خودروی بیشتری اضافه کنید. لطفاً یک پلن خریداری کنید تا خودرو اضافه کنید", 'هشدار', 'warning');
      return false;
    }
