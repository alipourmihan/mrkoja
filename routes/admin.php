...
Route::prefix('/admin')->middleware('auth:admin', 'Demo')->group(function () {
  ...
  Route::prefix('listing-specification')->group(function () {
    ...
    Route::prefix('location')->group(function () {
      ...
      //  Neighborhood route
      Route::get('/neighborhood', 'Admin\Listing\Location\NeighborhoodController@index')->name('admin.listing_specification.location.neighborhood');

      Route::get('/get-state-neighborhood/{country}', 'Admin\Listing\Location\NeighborhoodController@getState')->name('admin.listing_specification.location.get-state-neighborhood');
      Route::post('/get-city-neighborhood', 'Admin\Listing\Location\NeighborhoodController@getCity')->name('admin.listing_specification.location.get-city-neighborhood');

      Route::post('/store-neighborhood', 'Admin\Listing\Location\NeighborhoodController@store')->name('admin.listing_specification.location.store_neighborhood');

      Route::post('/update-neighborhood', 'Admin\Listing\Location\NeighborhoodController@update')->name('admin.listing_specification.location.update_neighborhood');

      Route::post('/delete-neighborhood/{id}', 'Admin\Listing\Location\NeighborhoodController@destroy')->name('admin.listing_specification.location.delete_neighborhood');

      Route::post('/bulk-delete-neighborhood', 'Admin\Listing\Location\NeighborhoodController@bulkDestroy')->name('admin.listing_specification.location.bulk_delete_neighborhood');

      Route::post('/neighborhood/get-by-city', 'Admin\Listing\Location\NeighborhoodController@getByCity')->name('admin.listing_specification.location.neighborhood.get-by-city');
    });
  });

  // Category Location Pages
  Route::prefix('category-location-pages')->group(function () {
    Route::get('/', 'Admin\CategoryLocationPageController@index')->name('admin.category_location_pages.index');
    Route::get('/create', 'Admin\CategoryLocationPageController@create')->name('admin.category_location_pages.create');
    Route::post('/store', 'Admin\CategoryLocationPageController@store')->name('admin.category_location_pages.store');
    Route::get('/edit/{id}', 'Admin\CategoryLocationPageController@edit')->name('admin.category_location_pages.edit');
    Route::put('/update/{id}', 'Admin\CategoryLocationPageController@update')->name('admin.category_location_pages.update');
    Route::delete('/destroy/{id}', 'Admin\CategoryLocationPageController@destroy')->name('admin.category_location_pages.destroy');
  });
  ...
  Route::prefix('listing-management')->group(function () {
    ...
    Route::match(['get', 'post'], '/get-city', 'Admin\Listing\ListingController@getCity')->name('admin.listing_management.get-city');
    Route::match(['get', 'post'], '/get-neighborhood', 'Admin\Listing\ListingController@getNeighborhood')->name('admin.listing_management.get-neighborhood');
    Route::get('/child-categories/{parent}', 'Admin\Listing\ListingController@getChildCategories')->name('admin.listing_management.child_categories');
    ...
    Route::get('/create', 'Admin\Listing\ListingController@create')->name('admin.listing_management.create_listing');
    Route::get('/create/{vendor_id}', 'Admin\Listing\ListingController@create')->name('admin.listing_management.create_listing_with_vendor');
    ...
    Route::post('aminitie/cng', 'Admin\Listing\ListingController@aminitieUpdate')->name('admin.listing_management.update_aminitie');
