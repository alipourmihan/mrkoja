...
class QuickLinkController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        Session::flash('success', 'لینک سریع جدید با موفقیت اضافه شد!');
    ...
    public function update(Request $request)
    {
        ...
        Session::flash('success', 'لینک سریع با موفقیت به‌روزرسانی شد!');
    ...
    public function destroy($id)
    {
        ...
        return redirect()->back()->with('success', 'لینک سریع با موفقیت حذف شد!');
    }
}
