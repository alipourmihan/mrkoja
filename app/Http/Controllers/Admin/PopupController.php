...
class PopupController extends Controller
{
    ...
    public function store(StoreRequest $request)
    {
        ...
        Session::flash('success', 'پاپ‌آپ جدید با موفقیت اضافه شد!');
    ...
    public function updateStatus(Request $request, $id)
    {
        ...
        if ($request->status == 1) {
            ...
            Session::flash('success', 'پاپ‌آپ فعال شد!');
        } else {
            $popup->update(['status' => 0]);

            Session::flash('success', 'پاپ‌آپ غیرفعال شد!');
        }
    ...
    public function update(UpdateRequest $request, $id)
    {
        ...
        Session::flash('success', 'پاپ‌آپ با موفقیت به‌روزرسانی شد!');
    ...
    public function bulkDestroy(Request $request)
    {
        ...
        Session::flash('success', 'پاپ‌آپ‌ها با موفقیت حذف شدند!');
