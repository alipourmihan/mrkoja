...
class BlogController extends Controller
{
    ...
    public function store(StoreRequest $request)
    {
        ...
        Session::flash('success', 'وبلاگ جدید با موفقیت اضافه شد!');
    ...
    public function update(UpdateRequest $request, $id)
    {
        ...
        Session::flash('success', 'وبلاگ با موفقیت به‌روزرسانی شد!');
    ...
    public function destroy($id)
    {
        ...
        return redirect()->back()->with('success', 'وبلاگ با موفقیت حذف شد!');
    }
    ...
    public function bulkDestroy(Request $request)
    {
        ...
        Session::flash('success', 'وبلاگ‌ها با موفقیت حذف شدند!');
