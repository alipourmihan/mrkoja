...
class PackageController extends Controller
{
    ...
    public function updateSettings(Request $request)
    {
        ...
        $messages = [
            'expiration_reminder.required' => 'شماره روز الزامی است.',
            'expiration_reminder.numeric' => 'شماره روز باید یک عدد باشد.',
        ];
    ...
    public function store(PackageStoreRequest $request)
    {
        try {
            ...
            Session::flash('success', "پکیج جدید با موفقیت اضافه شد!");
    ...
    public function update(PackageUpdateRequest $request)
    {
        try {
            ...
            return DB::transaction(function () use ($request, $features) {
                ...
                Session::flash('success', "پکیج با موفقیت به‌روزرسانی شد!");
                return Response::json(['status' => 'success'], 200);
            });
        } catch (\Throwable $e) {
            return $e;
    ...
    public function bulkDelete(Request $request)
    {
        try {
            return DB::transaction(function () use ($request) {
                ...
                Session::flash('success', 'پکیج‌ها با موفقیت حذف شدند!');
                return response()->json(['status' => 'success'], 200);
            });
        } catch (\Throwable $e) {
            return $e;
