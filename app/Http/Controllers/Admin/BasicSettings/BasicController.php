...
class BasicController extends Controller
{
    ...
    public function updateFavicon(Request $request)
    {
        ...
        if ($request->hasFile('favicon')) {
            ...
            Session::flash('success', 'آیکون سایت با موفقیت به‌روزرسانی شد!');
        }
    ...
    public function updateLogo(Request $request)
    {
        ...
        if ($request->hasFile('logo')) {
            ...
            Session::flash('success', 'لوگو با موفقیت به‌روزرسانی شد!');
        }
    ...
    public function update_contact_page(Request $request)
    {
        ...
        Session::flash('success', 'صفحه تماس با موفقیت به‌روزرسانی شد!');
    ...
    public function updateThemeAndHome(Request $request)
    {
        ...
        Session::flash('success', 'نسخه قالب و صفحه اصلی با موفقیت به‌روزرسانی شد!');
    ...
    public function updateCurrency(CurrencyRequest $request)
    {
        ...
        Session::flash('success', 'اطلاعات ارز با موفقیت به‌روزرسانی شد!');
    ...
    public function updateAppearance(Request $request)
    {
        ...
        Session::flash('success', 'رنگ‌ها با موفقیت به‌روزرسانی شد!');
    ...
    public function updateMailToAdmin(Request $request)
    {
        ...
        $message = [
            'to_mail.required' => 'فیلد آدرس ایمیل ضروری است.'
        ];
    ...
    public function updateBreadcrumb(Request $request)
    {
        ...
        if ($request->hasFile('breadcrumb')) {
            ...
            Session::flash('success', 'برگه با موفقیت به‌روزرسانی شد!');
        }
    ...
    public function updateDisqus(Request $request)
    {
        ...
        Session::flash('success', 'اطلاعات Disqus با موفقیت به‌روزرسانی شد!');
    ...
    public function updateTawkTo(Request $request)
    {
        ...
        $messages = [
            'tawkto_status.required' => 'فیلد وضعیت tawk.to ضروری است.',
            'tawkto_direct_chat_link.required' => 'فیلد لینک chat tawk.to ضروری است.'
        ];
    ...
    public function updateRecaptcha(Request $request)
    {
        ...
        $messages = [
            'google_recaptcha_status.required' => 'فیلد وضعیت recaptcha ضروری است.',
            'google_recaptcha_site_key.required' => 'فیلد کلید سایت recaptcha ضروری است.',
            'google_recaptcha_secret_key.required' => 'فیلد کلید سریال recaptcha ضروری است.'
        ];
        ...
        Session::flash('success', 'اطلاعات Recaptcha با موفقیت به‌روزرسانی شد!');
    ...
    public function updateFacebook(Request $request)
    {
        ...
        $messages = [
            'facebook_login_status.required' => 'فیلد وضعیت ورود ضروری است.',
            'facebook_app_id.required' => 'فیلد کلید برنامه ضروری است.',
            'facebook_app_secret.required' => 'فیلد کلید سریال برنامه ضروری است.'
        ];
        ...
        Session::flash('success', 'اطلاعات Facebook با موفقیت به‌روزرسانی شد!');
    ...
    public function updateGoogle(Request $request)
    {
        ...
        $messages = [
            'google_login_status.required' => 'فیلد وضعیت ورود ضروری است.',
            'google_client_id.required' => 'فیلد کلید مشتری ضروری است.',
            'google_client_secret.required' => 'فیلد کلید سریال مشتری ضروری است.'
        ];
        ...
        Session::flash('success', 'اطلاعات Google با موفقیت به‌روزرسانی شد!');
    ...
    public function updateWhatsApp(Request $request)
    {
        ...
        Session::flash('success', 'اطلاعات WhatsApp با موفقیت به‌روزرسانی شد!');
    ...
    public function updateMaintenance(Request $request)
    {
        ...
        if (!$request->filled('maintenance_img') && is_null($data->maintenance_img)) {
            ...
            $messages['maintenance_img.required'] = 'فیلد تصویر نگهداری ضروری است.';
        }
        ...
        $messages['maintenance_msg.required'] = 'فیلد پیام نگهداری ضروری است.';
        ...
        Session::flash('success', 'اطلاعات نگهداری با موفقیت به‌روزرسانی شد!');
    ...
    public function updateSettings(Request $request)
    {
        ...
        Session::flash('success', 'اطلاعات فروشگاه با موفقیت به‌روزرسانی شد!');
    ...
    public function updateProductTaxAmount(Request $request)
    {
        ...
        Session::flash('success', 'مقدار مالیات با موفقیت به‌روزرسانی شد!');
    ...
    public function updateCheckoutStatus(Request $request)
    {
        ...
        Session::flash('success', 'وضعیت با موفقیت به‌روزرسانی شد!');
    ...
    public function updatePwa(Request $request)
    {
        ...
        return back()->with('success', 'با موفقیت به‌روزرسانی شد!');
    }
    ...
    public function update_general_setting(Request $request)
    {
        ...
        Session::flash('success', 'اطلاعات عمومی با موفقیت به‌روزرسانی شد!');
