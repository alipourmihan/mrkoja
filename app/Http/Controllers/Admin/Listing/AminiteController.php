...
class AminiteController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        Session::flash('success', 'امینیت با موفقیت ذخیره شد!');
    ...
    public function update(Request $request)
    {
        ...
        Session::flash('success', 'امینیت با موفقیت به‌روزرسانی شد!');
    ...
    public function destroy($id)
    {
        ...
        if ($found) {
            return redirect()->back()->with('warning', 'ابتدا تمام آگهی‌های این امینیت را حذف کنید!');
        } else {
            $aminiteInfo = Aminite::query()->find($id);
            $aminiteInfo->delete();
            return redirect()->back()->with('success', 'امینیت با موفقیت حذف شد!');
        }
    }
    ...
    public function bulkDestroy(Request $request)
    {
        ...
        if ($errorOccurred == true) {
            Session::flash('warning', 'ابتدا تمام آگهی‌های این امینیت‌ها را حذف کنید!');
        } else {
