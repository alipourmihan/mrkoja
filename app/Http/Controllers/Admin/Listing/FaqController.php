...

{
    public function index(Request $request, $id)
    {
        ...
        if ($permissions) {
            ...
            Session::flash('warning', "دسترسی سوالات متداول این فروشنده اعطا نشده است.");
    ...
    public function store(Request $request)
    {
        ...
        if ($totalFaq < packageTotalFaqs($request->listing_id)) {
            ...
            Session::flash('warning', "محدودیت سوالات متداول به پایان رسیده یا از آن فراتر رفته است");
            return Response::json(['status' => 'success'], 200);
        }
    }
    ...
    public function bulkDestroy(Request $request)
    {
        ...
        Session::flash('success', 'سوالات متداول با موفقیت حذف شدند!');
        return Response::json(['status' => 'success'], 200);
    }
}
