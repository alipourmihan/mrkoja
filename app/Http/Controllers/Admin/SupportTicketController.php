...
class SupportTicketController extends Controller
{
    ...
    public function ticket_closed($id)
    {
        ...
        Session::flash('success', 'پشتیبانی با موفقیت بسته شد!');
        return back();
    }
    ...
    public function update_setting(Request $request)
    {
        ...
        $status->save();
        Session::flash('success', 'وضعیت پشتیبانی با موفقیت به‌روزرسانی شد!');
        return back();
    }
    ...
    public function assign_stuff(Request $request, $id)
    {
        if($request->admin_id){
            ...
            $support_ticket->save();
            Session::flash('success', 'ادمین به پشتیبانی اضافه شد!');
            return back();
        }else{
            Session::flash('warning', 'لطفا یک ادمین انتخاب کنید!');
            return back();
        }
    ...
    public function unassign_stuff($id)
    {
        ...
        Session::flash('success', 'ادمین از پشتیبانی حذف شد!');
        return back();
    }
    ...
    public function bulk_delete(Request $request)
    {
        ...
        Session::flash('success', 'پشتیبانی‌ها با موفقیت حذف شدند!');
