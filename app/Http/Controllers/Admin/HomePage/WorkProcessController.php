...
class WorkProcessController extends Controller
{
    ...
    public function updateSectionInfo(Request $request)
    {
        ...
        Session::flash('success', 'بخش فرایند کار با موفقیت به‌روزرسانی شد!');
    ...
    public function storeWorkProcess(Request $request)
    {
        ...
        Session::flash('success', 'فرایند کار جدید با موفقیت اضافه شد!');
    ...
    public function updateWorkProcess(Request $request)
    {
        ...
        Session::flash('success', 'فرایند کار با موفقیت به‌روزرسانی شد!');
    ...
    public function destroyWorkProcess($id)
    {
        ...
        return redirect()->back()->with('success', 'فرایند کار با موفقیت حذف شد!');
    }
    ...
    public function bulkDestroyWorkProcess(Request $request)
    {
        ...
        Session::flash('success', 'فرایندهای کار با موفقیت حذف شدند!');
