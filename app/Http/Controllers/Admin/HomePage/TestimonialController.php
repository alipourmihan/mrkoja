...
class TestimonialController extends Controller
{
    ...
    public function updateSectionBackground(Request $request)
    {
        ...
        Session::flash('success', 'تصویر پس‌زمینه بخش نظرات با موفقیت به‌روزرسانی شد!');
    ...
    public function updateSectionInfo(Request $request)
    {
        ...
        Session::flash('success', 'بخش نظرات با موفقیت به‌روزرسانی شد!');
    ...
    public function storeTestimonial(StoreRequest $request)
    {
        ...
        Session::flash('success', 'نظر جدید با موفقیت اضافه شد!');
    ...
    public function updateTestimonial(UpdateRequest $request)
    {
        ...
        Session::flash('success', 'نظر با موفقیت به‌روزرسانی شد!');
    ...
    public function bulkDestroyTestimonial(Request $request)
    {
        ...
        Session::flash('success', 'نظرات با موفقیت حذف شدند!');
