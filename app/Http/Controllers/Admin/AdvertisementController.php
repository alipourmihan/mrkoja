...
class AdvertisementController extends Controller
{
    ...
    public function updateAdvertiseSettings(Request $request)
    {
        ...
        Session::flash('success', 'تنظیمات تبلیغات با موفقیت به‌روزرسانی شد!');
    ...
    public function store(StoreRequest $request)
    {
        ...
        Session::flash('success', 'تبلیغ جدید با موفقیت اضافه شد!');
    ...
    public function update(UpdateRequest $request)
    {
        ...
        Session::flash('success', 'تبلیغ با موفقیت به‌روزرسانی شد!');
    ...
    public function bulkDestroy(Request $request)
    {
        ...
        Session::flash('success', 'تبلیغات با موفقیت حذف شدند!');
