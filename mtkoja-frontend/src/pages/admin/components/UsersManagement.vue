      ...
      <div class="relative top-10 mx-auto p-5 border w-11/12 md:w-4/5 lg:w-1/2 shadow-lg rounded-md bg-white">
        <div class="mt-3">
          ...
          <div v-if="selectedUser" class="mt-4 space-y-4">
            ...
            <div v-if="selectedUser.businesses && selectedUser.businesses.length > 0">
              ...
              <div class="space-y-2">
                ...
                >
                  <div class="flex justify-between items-start">
                    <div>
                      <h4 class="text-sm font-medium text-gray-900">{{ business.name }}</h4>
                      <p class="text-sm text-gray-500">{{ business.category.name }}</p>
                    </div>
                    <span :class="[
                      'inline-flex px-2 py-1 text-xs font-semibold rounded-full',
...
const viewUserDetails = async (user) => {
  try {
    ...
    selectedUser.value = { ...user, businesses: response.data.businesses }
