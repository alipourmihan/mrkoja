              ...
              <form id="productForm" action="{{ route('admin.shop_management.update_product', ['id' => $product->id]) }}"
                  ...
                  @if ($productType == 'digital')
                    ...
                    <div class="col-12">
                      ...
                      <div class="form-group {{ $product->input_type == 'link' ? '' : 'd-none' }}" id="link-input">
                        <label>{{ __('Link') . '*' }}</label>
                        <input type="url" class="form-control" name="link" placeholder="{{__("Enter Download Link")}}"
                          value="{{ $product->link }}">
                      </div>
                    </div>
                  @endif
                  ...
                  @if ($productType == 'physical')
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="stock" placeholder="{{__("Enter Product Stock")}}"
                          value="{{ $product->stock }}">
                      </div>
                    </div>
                  @endif
                ...
                <div id="accordion" class="mt-5">
                  @foreach ($languages as $language)
                    @php $productData = $language['productData'] ?? null; @endphp

                    <div class="version">
                      <div class="version-header" id="heading{{ $language['id'] }}">
                        <h5 class="mb-0">
                          <button type="button"
                            class="btn btn-link {{ $language['direction'] == 1 ? 'rtl text-left' : '' }}"
                      ...
                      <div id="collapse{{ $language['id'] }}"
                        ...
                        <div class="version-body">
                          <div class="row">
                            ...
                            @php $categories = $language->productCategory()->where('status', 1)->orderByDesc('id')->get();; @endphp
                            <div class="col-lg-6">
                              <div class="form-group {{ $language['direction'] == 1 ? 'rtl text-left' : '' }}">
