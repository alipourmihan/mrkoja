      ...
      <div class="card">
        <div class="card-header">
          <div class="row">
            <div class="col-lg-4">
              @php
                $vendori = App\Models\User::Where('id', $ticket->user_id)->first();
              @endphp
            ...
            <div class="col-lg-3 offset-lg-5 mt-2 mt-lg-0 text-left">
              ...
              @if (count($ticket->messages) > 0)
                @foreach ($ticket->messages as $reply)
                  ...
                  @else
                    ...
                    @elseif ($reply->type == 3)
                      @php
                        $vendor = App\Models\User::where('id', $ticket->user_id)->first();
                      @endphp
                      <div class="item-list">
                        <div class="avatar">
                          @if ($vendor)
