            ...
            <div class="row">
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <input class="form-control" name="meta_keyword_home"
                    value="{{ is_null($data) ? '' : $data->meta_keyword_home }}" placeholder="{{ __('Enter Meta Keywords') }}"
                    data-role="tagsinput">
                </div>

                <div class="form-group">
                  <label>{{ __('Meta Description For Home Page') }}</label>
                  <textarea class="form-control" name="meta_description_home" rows="5" placeholder="{{ __('Enter Meta Description') }}">{{ is_null($data) ? '' : $data->meta_description_home }}</textarea>
                </div>
              </div>
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <input class="form-control" name="meta_keyword_pricing"
                    value="{{ is_null($data) ? '' : $data->meta_keyword_pricing }}" placeholder="{{ __('Enter Meta Keywords') }}"
                    data-role="tagsinput">
                </div>

                <div class="form-group">
                  <label>{{ __('Meta Description For Pricing Page') }}</label>
                  <textarea class="form-control" name="meta_description_pricing" rows="5" placeholder="{{ __('Enter Meta Description') }}">{{ is_null($data) ? '' : $data->meta_description_pricing }}</textarea>
                </div>
              </div>
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <input class="form-control" name="meta_keyword_listings"
                    value="{{ is_null($data) ? '' : $data->meta_keyword_listings }}" placeholder="{{ __('Enter Meta Keywords') }}"
                    data-role="tagsinput">
                </div>

                <div class="form-group">
                  <label>{{ __('Meta Description For Listings Page') }}</label>
                  <textarea class="form-control" name="meta_description_listings" rows="5" placeholder="{{ __('Enter Meta Description') }}">{{ is_null($data) ? '' : $data->meta_description_listings }}</textarea>
                </div>
              </div>
              ...
              <div class="col-lg-6">
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" name="meta_description_vendor_page" rows="5" placeholder="{{ __('Enter Meta Description') }}">{{ is_null($data) ? '' : $data->meta_description_vendor_page }}</textarea>
                </div>
              </div>
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <input class="form-control" name="meta_keyword_products"
                    value="{{ is_null($data) ? '' : $data->meta_keyword_products }}" placeholder="{{ __('Enter Meta Keywords') }}"
                    data-role="tagsinput">
                </div>

                <div class="form-group">
                  <label>{{ __('Meta Description For Products Page') }}</label>
                  <textarea class="form-control" name="meta_description_products" rows="5" placeholder="{{ __('Enter Meta Description') }}">{{ is_null($data) ? '' : $data->meta_description_products }}</textarea>
                </div>
              </div>
              ...
              <div class="col-lg-6">
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" name="meta_description_blog" rows="5" placeholder="{{ __('Enter Meta Description') }}">{{ is_null($data) ? '' : $data->meta_description_blog }}</textarea>
                </div>
              </div>
              ...
              <div class="col-lg-6">
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" name="meta_description_faq" rows="5" placeholder="{{ __('Enter Meta Description') }}">{{ is_null($data) ? '' : $data->meta_description_faq }}</textarea>
                </div>
              </div>
              ...
              <div class="col-lg-6">
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" name="meta_description_contact" rows="5" placeholder="{{ __('Enter Meta Description') }}">{{ is_null($data) ? '' : $data->meta_description_contact }}</textarea>
                </div>
              </div>
              ...
              <div class="col-lg-6">
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" name="meta_description_login" rows="5" placeholder="{{ __('Enter Meta Description') }}">{{ is_null($data) ? '' : $data->meta_description_login }}</textarea>
                </div>
              </div>
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <input class="form-control" name="meta_keyword_signup"
                    value="{{ is_null($data) ? '' : $data->meta_keyword_signup }}" placeholder="{{ __('Enter Meta Keywords') }}"
                    data-role="tagsinput">
                </div>

                <div class="form-group">
                  <label>{{ __('Meta Description For Customer Signup Page') }}</label>
                  <textarea class="form-control" name="meta_description_signup" rows="5" placeholder="{{ __('Enter Meta Description') }}">{{ is_null($data) ? '' : $data->meta_description_signup }}</textarea>
                </div>
              </div>
