<!DOCTYPE html>
@php
  $currentLang = session()->get('currentLangCode') ?? app()->getLocale();
  $isRtlLang = $currentLang === 'fa';
@endphp
...
<body data-background-color="{{ $settings->admin_theme_version == 'light' ? 'white' : 'dark' }}" class="{{ $isRtlLang ? 'rtl-enabled vazir-font' : '' }}">
  {{-- loader start --}}
