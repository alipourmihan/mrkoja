        ...
        <div class="card-header">
          <div class="row">
            ...
            <div class="col-lg-6 offset-lg-2">
              <button class="btn btn-danger btn-sm float-left d-none bulk-delete ml-3 mt-1" data-href="{{ route('admin.user_management.bulk_delete_subscriber') }}">
                <i class="flaticon-interface-5"></i> {{ __('Delete') }}
              </button>

              <a href="{{ route('admin.user_management.mail_for_subscribers') }}" class="btn btn-primary btn-sm float-left ml-3 mt-1 mb-1">
                <i class="fal fa-paper-plane"></i> {{ __('Send Mail') }}
              </a>

              <form class="float-left" action="{{ route('admin.user_management.subscribers') }}" method="GET">
