        ...
        <div class="card-header">
          <div class="row">
            ...
            <div class="col-lg-6 offset-lg-2">
              <button class="btn btn-danger btn-sm float-left d-none bulk-delete mr-2 ml-3 mt-1"
                data-href="{{ route('admin.vendor_management.bulk_delete_vendor') }}">
                <i class="flaticon-interface-5"></i> {{ __('Delete') }}
              </button>

              <form class="float-left" action="{{ route('admin.vendor_management.registered_vendor') }}" method="GET">
