...
@section('content')
  <div class="mt-2 mb-4">
    ...
    <span id="jalali-date">{{ $currentJalaliDate }}</span>
    </div>
  </div>
  ...
  <div class="row dashboard-items">
      ...
      <div class="col-sm-12 col-md-6">
        <div class="card">
          <div class="card-header">
            <div class="card-title">{{ __('Monthly Package Purchase') }} ({{ \JalaliDate::toJalali(date('Y-1-1'),'Y') }})</div>
          </div>
          <div class="card-body">
    ...
    @if (is_null($roleInfo) || (!empty($rolePermissions) && in_array('User Management', $rolePermissions)))
      <div class="col-sm-12 col-md-6">
        <div class="card">
          <div class="card-header">
            <div class="card-title">{{ __('Month wise registered users') }} ({{ \JalaliDate::toJalali(date('Y-1-1'),'Y') }})</div>
          </div>
          <div class="card-body">
            <div class="chart-container">
...
@section('script')
  ...
  <script>
    ...
    const jalaliMonthArr = @php echo json_encode($jalaliMonthArr) @endphp;
