                    ...
                    <tbody>
                      @foreach ($listings as $listing)
                        @php
                          ...
                          if (empty($listing->user_id) || $listing->user_id == 0) {
                              $vendorId = 0;
                              $current_package = [];
                              $permissions = [
                        ...
                        <tr>
                          ...
                          <td class="title">
                            @if (!empty($listing_content) && !empty($listing_content->slug) && trim($listing_content->slug) != '')
                              <a href="{{ route('frontend.listing.details', ['slug' => $listing_content->slug, 'id' => $listing->id]) }}"
                                target="_blank">
                                {{ strlen(@$listing_content->title) > 50 ? mb_substr(@$listing_content->title, 0, 50, 'utf-8') . '...' : @$listing_content->title }}
                              </a>
                            @elseif (!empty($listing_content))
                              <span>{{ strlen(@$listing_content->title) > 50 ? mb_substr(@$listing_content->title, 0, 50, 'utf-8') . '...' : @$listing_content->title }}</span>
                            @else
                              --
                            @endif
                          </td>
                          ...
                          <td>
                            ...
                            @else
                                ...
                                class="btn btn-primary btn-sm" title="{{ __('ویرایش') }}">
