              ...
              <form id="listingForm" action="{{ route('admin.listing_management.store_listing') }}" method="POST"
                ...
                <div class="row">
                  @if (is_array($permissions) && in_array('Video', $permissions))
                    <div class="col-lg-3">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="video_url" placeholder="{{ __('Enter Your video url') }}">
                      </div>
                    </div>
                  @endif
                  ...
                  <div class="col-lg-3">
                    <div class="form-group">
                      <label>{{ __('Mail') }} *</label>
                      <input type="text" class="form-control" name="mail" placeholder="{{ __('Enter Contact Mail') }}">
                    </div>
                  </div>
                  <div class="col-lg-3">
                    <div class="form-group">
                  ...
                  <div class="col-lg-3">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="latitude" placeholder="{{ __('Enter Latitude') }}">
                  ...
                  <div class="col-lg-3">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="longitude" placeholder="{{ __('Enter Longitude') }}">
                      <p class="text-warning">
                      ...
                      <div class="version-header" id="heading{{ $language->id }}">
                        <h5 class="mb-0">
                          <button type="button" class="btn btn-link" data-toggle="collapse"
                            ...
                            {{ $language->name . __('زبان') }} {{ $language->is_default == 1 ? '(Default)' : '' }}
                          </button>
                        </h5>
                      </div>
                      ...
                      <div id="collapse{{ $language->id }}"
                        ...
                        <div class="version-body {{ $language->direction == 1 ? 'rtl text-right' : '' }}">
                          <div class="row">
                            ...
                            @php
                              $StatesQuery = App\Models\Location\State::query();
                              if (\Illuminate\Support\Facades\Schema::hasColumn('states', 'language_id')) {
                                  $StatesQuery->where('language_id', $language->id);
                              }
                              ...
                              <div class="col-lg-3">
                                <div class="form-group {{ $language->direction == 1 ? 'rtl text-right' : '' }}">
                                  ...
                                  <select name="{{ $language->code }}_state_id"
                                    class="form-control js-example-basic-single4 {{ $language->code }}_state_select"
                            ...
                            @php
                              $citiesQuery = App\Models\Location\City::query();
                              if (\Illuminate\Support\Facades\Schema::hasColumn('cities', 'language_id')) {
                                  $citiesQuery->where('language_id', $language->id);
                              }
