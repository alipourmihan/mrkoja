    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          ...
          @if ($vendor_id != 0)
            <button type="button" class="btn btn-primary btn-sm btn-sm btn-round float-left" id="aa"
                  ...
                  <div class="col-lg-3">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" value="{{ $listing->mail }}" name="mail"
                        placeholder="{{ __('Enter Your Mail') }}">
                    </div>
                  </div>
                  <div class="col-lg-3">
                    <div class="form-group">
                  ...
                  @foreach ($languages as $language)
                    ...
                    <div class="version">
                      ...
                      <div id="collapse{{ $language->id }}"
                        ...
                        <div class="version-body {{ $language->direction == 1 ? 'rtl text-left' : '' }}">
                          <div class="row">
                            <div class="col-lg-6">
                              <div class="form-group {{ $language->direction == 1 ? 'rtl text-left' : '' }}">
