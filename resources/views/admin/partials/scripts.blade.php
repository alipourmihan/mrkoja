...
<script type="text/javascript" src="{{ asset('assets/admin/css/brtl/js/bootstrap.min.js') }}"></script>
...
{{-- datatable-persian js --}}
<script src="{{ asset('assets/admin/js/datatable-persian.js') }}"></script>

{{-- bootstrap persian datepicker --}}
