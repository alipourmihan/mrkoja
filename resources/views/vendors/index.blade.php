...
@section('content')
  <div class="mt-2 mb-4">
    <h2 class="pb-2">{{ __('Welcome back,') }} {{ Auth::user()->username . '!' }}</h2>
  </div>
  @if (Auth::user()->status == 0 && $admin_setting->vendor_admin_approval == 1)
    <div class="mt-2 mb-4">
  ...
  <div class="row dashboard-items">
    ...
    <div class="col-lg-6">
      <div class="card">
        <div class="card-header">
          <div class="card-title">{{ __('Monthly Listing Posts') }} ({{ jdate_en('Y') }})</div>
        </div>
    ...
    <div class="col-lg-6">
      <div class="card">
        <div class="card-header">
          <div class="card-title">{{ __('Monthly Visitors') }} ({{ jdate_en('Y') }})</div>
        </div>
