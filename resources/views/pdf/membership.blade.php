  ...
  <div class="main">
    <table class="heading">
      <tr>
        ...
        <td class="text-left strong invoice-heading">{{ __('INVOICE') }}</td>
      </tr>
    </table>
    <div class="header">
      <div class="ml-20">
    ...
    <table class="mt-80">
      <tr>
        <td class="text-left regards">{{ __('Thanks & Regards') . ',' }}</td>
      </tr>
      <tr>
        <td class="text-left strong regards">{{ $websiteInfo->website_title }}</td>
      </tr>
    </table>
  </div>
