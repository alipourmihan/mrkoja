        ...
        <form method="post" action="{{ route('LaravelInstaller::licenseCheck') }}" class="tabs-wrap">
            ...
            <div>
                <div class="form-group {{ $errors->has('email') ? ' has-error ' : '' }}">
                    ...
                    <input type="text" name="email" id="email" value="" placeholder="{{ __('Your Mail Address') }}" />
                    <p>{{ __('This Mail Address will be used to inform you about Urgent Notices, Announcements, Offers / Sales etc...') }}</p>
                    @if ($errors->has('email'))
                ...
                <div class="form-group {{ $errors->has('username') ? ' has-error ' : '' }}">
                    ...
                    <input type="text" name="username" id="username" value="" placeholder="{{ __('Username of Your Envato Account') }}" />
                ...
                <div class="form-group {{ $errors->has('purchase_code') ? ' has-error ' : '' }}">
                    ...
                    <input type="text" name="purchase_code" id="purchase_code" value="" placeholder="{{ __('Your Item Purchase Code') }}" />
