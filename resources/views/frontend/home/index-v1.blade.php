        ...
        <div class="row">
          <div class="col-12">
            <div class="section-title title-inline mb-30" data-aos="fade-up">
              <h2 class="title mb-20"><span class="line">{{ $listingSecInfo ? $listingSecInfo->title : __('LISTINGS') }}
                </span></h2>
            </div>
          </div>
          <div class="col-12">
                        ...
                        <div class="product-default border radius-md mb-25">
                          ...
                          <div class="product-details">
                            <div class="product-top mb-10">
                              @php
                                if ($listing_content->user_id == 0) {
                                    $vendorInfo = App\Models\Admin::first();
                                    $userName = 'admin';
                                } else {
                                    $vendorInfo = App\Models\User::findorfail($listing_content->user_id);
                          ...
                          <div class="pricing-item radius-lg {{ $package->recommended ? 'active' : '' }} mb-30">
                            ...
                            @if(Auth::check() && Auth::user()->isBusiness())
                              <a href="javascript:void(0)"
                                class="btn btn-outline btn-lg disabled" title="{{ __('Purchasing disabled') }}"
                                target="_self">{{ __('Purchase') }}</a>
                            @endif
                            @if(!Auth::check() || (Auth::check() && !Auth::user()->isBusiness()))
    ...
    <section class="blog-area pt-100 pb-75">
      <div class="container">
        <div class="row">
          <div class="col-12">
            <div class="section-title title-inline mb-30" data-aos="fade-up">
              <h2 class="title mb-20">{{ !empty($blogSecInfo->title) ? $blogSecInfo->title : __('Read Our Latest Blog') }}
              </h2>
