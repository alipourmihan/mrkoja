            ...
            <div class="accordion-body scroll-y">
              <ul class="list-group custom-radio">
                ...
                <li>
                  ...
                  <label class="form-radio-label" for="radioR-4"><span>{{ __('4 stars and above') }}</span>
                  </label>
                </li>
                ...
                <li>
                  ...
                  <label class="form-radio-label" for="radioR-3"><span>{{ __('3 stars and above') }}</span>
                  </label>
                </li>
                ...
                <li>
                  ...
                  <label class="form-radio-label" for="radioR-2"><span>{{ __('2 stars and above') }}</span>
                  </label>
                </li>
                ...
                <li>
                  ...
                  <label class="form-radio-label" for="radioR-1"><span>{{ __('1 star and above') }}</span>
                  </label>
                </li>
              </ul>
            </div>
