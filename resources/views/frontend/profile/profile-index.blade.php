                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="form-group mb-30">
                                                        <input type="text" class="form-control" placeholder="{{ __('First Name') }}" name="name" required>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                                    <div class="form-group mb-30">
                                                        <input type="text" class="form-control" placeholder="{{ __('Last Name') }}" name="name" required>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                                    <div class="form-group mb-30">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group mb-30">
                                                        <select class="form-control" id="country">
                                                            ...
                                                            <option value="England">{{ __('England') }}</option>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="custom-checkbox mb-30">
                                                        ...
                                                        <label class="form-check-label" for="checkbox3"><span>{{ __('Male') }}</span></label>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                                    <div class="custom-radio mb-30">
                                                        <input class="input-radio" type="radio" name="radio" id="radio3" value="">
                                                        <label class="form-radio-label" for="radio3"><span>{{ __('Female') }}</span></label>
                                                    </div>
                                                </div>
                                                <div class="col-lg-12">
                                                    <div class="form-group mb-30">
