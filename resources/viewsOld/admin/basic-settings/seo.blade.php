              ...
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <input class="form-control" name="meta_keyword_pricing"
                    value="{{ is_null($data) ? '' : $data->meta_keyword_pricing }}" placeholder="Enter Meta Keywords"
                    data-role="tagsinput">
                </div>

                <div class="form-group">
                  <label>{{ __('Meta Description For Pricing Page') }}</label>
                  <textarea class="form-control" name="meta_description_pricing" rows="5" placeholder="Enter Meta Description">{{ is_null($data) ? '' : $data->meta_description_pricing }}</textarea>
                </div>
              </div>
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <input class="form-control" name="meta_keyword_listings"
                    value="{{ is_null($data) ? '' : $data->meta_keyword_listings }}" placeholder="Enter Meta Keywords"
                    data-role="tagsinput">
                </div>

                <div class="form-group">
                  <label>{{ __('Meta Description For Listings Page') }}</label>
                  <textarea class="form-control" name="meta_description_listings" rows="5" placeholder="Enter Meta Description">{{ is_null($data) ? '' : $data->meta_description_listings }}</textarea>
                </div>
              </div>
